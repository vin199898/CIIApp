...
model =  pickle.load(open('C:/Users/harvi/testing/modelbulk2.sav', 'rb'))
...
def app():
   ...
   # FUNCTION
    def user_report(): 
      ...
      global speed
      global distance
      dwt = st.number_input('Enter Deadweight (Tonnes)', min_value = 5500.0, max_value = 230000.0, step=0.1)
      speed = st.number_input('Enter Service Speed (Knots)', min_value = 10.0, max_value = 30.0, step = 0.1)
      loa = st.number_input('Enter Length Overall (M)', min_value = 100.0, max_value = 400.0, step =0.1)
